#!/usr/bin/env python3
"""
Task 4b: Basic Tool Use — Pod Health Checker — Google Gemini
...
def main():
    print("=" * 65)
    print("Task 4b: Basic Tool Use — Pod Health Checker — Google Gemini")
    print("=" * 65)

    genai.configure(api_key=os.environ["GOOGLE_API_KEY"])

    # TODO 1: Define the tool using FunctionDeclaration
    ...
    # TODO 2: Send the query — Gemini decides whether to call the tool
    chat = model.start_chat()
    response = chat.send_message(___)  # TODO: Use query
