...
Learn how the system prompt shapes the entire response.
...
def main():
    ...
    # The alert we use throughout (PRE-FILLED)
...
Current Memory Usage: 255Mi (99.6%)"""
    ...
    # TODO 2: Add a system prompt to shape the response
    message = client.messages.create(
        model="claude-sonnet-4-6-latest",
        max_tokens=1024,
        system=___,  # TODO: Use "You are a senior SRE with 10 years of Kubernetes experience. Be concise and actionable."
        messages=[{"role": "user", "content": alert}]
    )

    print(message.content[0].text)
    print("\nSee the difference? One line changed everything.")

    print("\n" + "=" * 65)
    print("Key Learning: The system prompt is the most powerful lever you have.")
    print("=" * 65)
