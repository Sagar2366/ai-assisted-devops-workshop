#!/usr/bin/env python3
"""
Task 4b: Basic Tool Use — Pod Health Checker — AWS Bedrock
...
def main():
    print("=" * 65)
    print("Task 4b: Basic Tool Use — Pod Health Checker — AWS Bedrock")
    print("=" * 65)

    bedrock = boto3.client("bedrock-runtime", region_name="us-east-1")

    # TODO 1: Define the tool in Bedrock's toolConfig format
    tool_config = {
        "tools": [
            {
                "toolSpec": {
