...
{{"name": "...", "skill_level": "...", "interests": [...], "goals": [...], "communication_style": "..."}}"""
    ...
    profile_json = profile_result["content"][0]["text"]
...
Prefers: {user_profile.get('communication_style', 'technical')} explanations."""
    ...
    reply = call_bedrock(bedrock, personalized_system, [{"role": "user", "content": test_query}], max_tokens=512)
    print(reply[:200])
    ...
    print("\nTask 8 Complete!")
    print("Next: python3 demos/bedrock/task9_basic_tool.py")
