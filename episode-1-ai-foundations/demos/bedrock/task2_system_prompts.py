...
Current Memory Usage: 255Mi (99.6%)"""
    ...
    # TODO 1: Send the alert WITHOUT a system prompt via Bedrock
    ...
    # TODO 2: Add a system prompt to the Bedrock call
    # In Bedrock's Anthropic format, system prompt is a top-level field in the JSON body
    response = bedrock.invoke_model(
        modelId="anthropic.claude-sonnet-4-20250514-v1:0",
        body=json.dumps({
            "anthropic_version": "bedrock-2023-05-31",
    ...
    print("The API format differs, but the concept is universal.")
    print("")
