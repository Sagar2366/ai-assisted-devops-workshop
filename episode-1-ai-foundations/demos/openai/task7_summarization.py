...
This preserves key information while staying within token limits.
...
def main():
    ...
    # Old conversation history (too long to keep sending every turn)
    old_conversation = [
    ...
    # TODO 1: Write the summarization prompt
    # Ask the model to condense the conversation into key facts
    summarization_prompt = ___  # TODO: Use "Summarize this conversation into 3-4 bullet points. Focus on: the problem, root cause found, and actions taken. Be concise.\n\nConversation:\n" + "\n".join([f"{m['role']}: {m['content']}" for m in old_conversation])
    ...
    # Step 2: Use summary as context for new conversation
    print("\n" + "-" * 65)
    ...
    # TODO 2: Inject the summary as part of the system message
    # This gives the model context about the old conversation without sending all messages
    system_with_summary = ___  # TODO: Use f"You are an SRE assistant. Here is a summary of our previous conversation:\n\n{summary}\n\nUse this context to answer follow-up questions."
    ...
    print("into short context. You trade some detail for massive token")
    print("savings. Compare the two responses — the one with summary")
    print("gives a more relevant, connected answer.")
    print("=" * 65)
