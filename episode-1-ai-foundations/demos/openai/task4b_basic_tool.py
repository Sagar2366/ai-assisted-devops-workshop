#!/usr/bin/env python3
"""
Task 4b: Basic Tool Use — Pod Health Checker — OpenAI GPT
...
def main():
    print("=" * 65)
    print("Task 4b: Basic Tool Use — Pod Health Checker — OpenAI GPT")
    print("=" * 65)

    client = openai.OpenAI()

    # TODO 1: Define the tool in OpenAI's function calling format
    tools = [
        {
            "type": "function",
            "function": {
    ...
    # TODO 2: Send the query with tools — GPT decides whether to call one
