...
async def main():
    ...
    # Build conversation with user info
    ...
    # TODO 1: Create extraction prompt
    extraction_prompt = ___  # TODO: Use f"Analyze this conversation and extract user info as JSON:\n\n{conv_text}\n\nReturn ONLY a JSON object:\n{{\"name\": \"...\", \"skill_level\": \"...\", \"interests\": [...], \"goals\": [...], \"communication_style\": \"...\"}}"
    ...
    # TODO 2: Create personalized system message
...
Prefers: {user_profile.get('communication_style', 'technical')} explanations."""
    ...
    personal_chat.add_system_message(___)  # TODO: Use personalized_system
    ...
    print("\nTask 8 Complete!")
    print("Next: python3 demos/maf/task9_simple_tool.py")
