...
Current Memory Usage: 255Mi (99.6%)"""
    ...
    chat = ChatHistory()
    chat.add_system_message("You are a senior SRE with 10 years of Kubernetes experience. Be concise and actionable. Give kubectl commands, not general advice.")
    chat.add_user_message(alert)
