...
Current Memory Usage: 255Mi (99.6%)"""
    ...
    # TODO 1: Define three expert personas
    personas = {
        "SRE Engineer": ___,  # TODO: Use "You are a senior SRE. Focus on immediate remediation, resource tuning, and preventing recurrence. Be specific with kubectl commands."
        ...
        "Cost Analyst": ___,  # TODO: Use "You are a cloud cost analyst. Focus on resource efficiency, right-sizing, and cost impact. Provide specific cost optimization recommendations."
    }
    ...
    for persona_name, system_prompt in personas.items():
        ...
        # TODO 2: Create chat history with the persona's system message
        chat = ChatHistory()
        chat.add_system_message(___)  # TODO: Use system_prompt
