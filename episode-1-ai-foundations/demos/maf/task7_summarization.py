...
async def main():
    ...
    summary_prompt = f"Summarize this conversation in 2-3 sentences, capturing the key topics and conclusions:\n\n{conv_text}"
    ...
    new_chat.add_system_message(f"You are a DevOps tutor. Previous conversation summary: {summary}")
